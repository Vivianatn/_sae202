...
function verif_connexion()
{
    ...
    {
        //on uilise la fonction verif_utilisateur du modèle clients_model
...
{
    //on vérifie si les champs sont bien remplis
    if(isset($_POST['user_email']) && isset($_POST['user_mdp']) && isset($_POST['user_mdp2']) && isset($_POST['user_prenom']) && isset($_POST['user_nom']) && isset($_POST['user_tel']))
    {
        ...
        if($_POST['user_mdp']==$_POST['user_mdp2'])
        {
            ...
            if(!$resultat)
            {
                ...
                //$mdp
                inscription_utilisateur($_POST['user_prenom'],$_POST['user_nom'], $_POST['user_email'], $_POST['user_tel'], $_POST['user_mdp']);
